  ...
  return (
    <nav className="Navbar" id="nav">
      ...
      <div className="SocialMedia">
        <span className="Twit">
          <a
            href="https://twitter.com/0xinfinity_labs"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <>
            <div className="sideNav" ref={node} data-aos="fade-left">
              <ul>
                ...
                <li>
                  <a href="#ab" onClick={() => setToggle(false)}>
                    Who are we
                  </a>
                </li>
                <li>
              ...
              <ul>
                <li>
                  <a href="#pass" onClick={() => setToggle(false)}>
                    Infinity Pass
                  </a>
                </li>
              </ul>
              <ul>
                <li>
                  <a href="#map" onClick={() => setToggle(false)}>
                    Roadmap
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#cont" onClick={() => setToggle(false)}>
                    Get in touch
                  </a>
                </li>
              </ul>
