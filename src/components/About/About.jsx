  ...
  return (
    <div className="About">
      <div className="abtHeader">
        ...
        <h1>
          WH<span>O</span> ARE WE?
        </h1>
        <div className="abtContent">
          <p>
            We are seeing many low effort, copycat NFT projects using buzz
            words, often they really offer anything to the holder. Some of them
            are cash grabs or even rug pulls. But on the other hand, there are
