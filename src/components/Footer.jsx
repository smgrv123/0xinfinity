            ...
            <div className="footer">
                ...
                <div className="socialMedia">
                    <div className="Discord">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#B3B3B3" class="bi bi-discord" viewBox="0 0 16 16">
                    ...
                    <div className="Twitter">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#B3B3B3" class="bi bi-twitter" viewBox="0 0 16 16">
